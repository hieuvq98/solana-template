...
pub fn c98_starship_program_test() -> ProgramTest {
    let program = ProgramTest::new("starship", starship::id(), None);
    program
}
...
pub fn hash_whitelist(redemption: starship::state::WhitelistParams)-> [u8 ;32]{
